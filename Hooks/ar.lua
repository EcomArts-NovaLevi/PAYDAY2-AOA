...
--M4A1
self.new_m4.AMMO_MAX = 450
self.new_m4.stats.damage = 80
self.new_m4.stats.concealment = 30

--Mk14 EBR
self.new_m14.AMMO_MAX = 140
self.new_m14.stats.damage = 165
